...
public class ConfirmDialogFragment extends DialogFragment {
    ...
    public void onStart() {
        ...
        getDialog().getWindow().setLayout(
                dm.widthPixels, getDialog().getWindow().getAttributes().height);
    ...
    public interface PositiveClickListener { void onClick(); }

    public interface NegativeClickListener { void onClick(); }
}
