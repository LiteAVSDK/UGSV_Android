...
public class TCPictureJoinActivity extends FragmentActivity {
    ...
    private IPictureJoinKit.OnPictureJoinListener mOnPictureJoinListener =
            new IPictureJoinKit.OnPictureJoinListener() {
                @Override
                public void onPictureJoinCompleted(UGCKitResult ugcKitResult) {
                    ...
                    if (ugcKitResult.errorCode == 0) {
                        ...
                        ToastUtil.toastShortMessage("join picture failed. error code:"
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         *  获取从图片路径集合，并设置给TUIKit {@link
         * UGCKitPictureJoin#setInputPictureList(ArrayList)}
         */
        mPicPathList =
