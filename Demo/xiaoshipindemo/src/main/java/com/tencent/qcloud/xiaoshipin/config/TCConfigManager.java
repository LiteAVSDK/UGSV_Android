...
public class TCConfigManager {
    ...
    public static class SystemConfig {
        private static class SystemConfigKeys { private static final String LANGUAGE = "LANGUAGE"; }
        ...
        public static int getLanguage() {
            SharedPreferences sharedPreferences =
                    mContext.getSharedPreferences(CONFIG_SPACE_SYSTEM, Context.MODE_PRIVATE);
