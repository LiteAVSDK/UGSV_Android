...
public class TCLoginActivity extends Activity {
    ...
    private int[][] chineseScrollProtocol = {
            {96, 107}, {285, 296}, {424, 438}, {509, 520}, {599, 610}};

    private int[][] englishScrollProtocol = {
            {385, 419}, {1054, 1093}, {1536, 1584}, {1969, 2019}, {2166, 2206}};
    ...
    public boolean isFirstStart() {
        SharedPreferenceUtils preferences =
                new SharedPreferenceUtils(this, SHARED_PREFERENCE_FILE_NAME_PERMISSION);
        Boolean isFirst =
                (Boolean) preferences.getSharedPreference(SHARED_PREFERENCE_FIRST_START, true);
        if (isFirst) {
            // 第一次
    ...
    private SpannableString showDownSpan() {
        final SpannableString builder =
                new SpannableString(getString(R.string.login_protocol_down));
        ...
        ClickableSpan privacyClickableSpan = new NoRefCopyClickableSpan() {
            ...
            public void onClick(View widget) {
                jumpToWebViewActivity(TCLoginActivity.this, null,
        ...
        builder.setSpan(protocolPersonalInformationClickableSpan, tempProtocolArray[2][0],
                tempProtocolArray[2][1], Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        ...
        builder.setSpan(protocolThirdPartEndClickableSpan, tempProtocolArray[3][0],
                tempProtocolArray[3][1], Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        ...
        ClickableSpan protocolChildrenPrivacyClickableSpan = new NoRefCopyClickableSpan() {
            ...
            public void onClick(View widget) {
                jumpToWebViewActivity(
                        TCLoginActivity.this, null, "https://privacy.qq.com/privacy-children.htm");
            }
        };
        builder.setSpan(protocolChildrenPrivacyClickableSpan, tempProtocolArray[4][0],
                tempProtocolArray[4][1], Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        return builder;
    }
    ...
    private SpannableStringBuilder showScrollSpan() {
        ...
        ClickableSpan privacyClickableSpan = new NoRefCopyClickableSpan() {
            ...
            public void onClick(View widget) {
                jumpToWebViewActivity(TCLoginActivity.this, null,
                        "https://privacy.qq.com/document/preview/ea00e5256ad442c483cd685d27b2e49f");
            }
        };
        builder.setSpan(privacyClickableSpan, tempProtocolArray[0][0], tempProtocolArray[0][1],
                Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                ...
                TCUserMgr.getInstance().autoLogin(new TCUserMgr.Callback() {
                    ...
                    public void onFailure(int code, final String msg) {
                        showToast(getResources().getString(
                                R.string.tc_login_activity_auto_login_failed));
                        showOnLoadingInUIThread(false);
                    }
                });
            }
            ...
            if (UserInfoUtil.isPasswordValid(password)) {
                if (NetworkUtil.isNetworkAvailable(this)) {
                    ...
                    ToastUtil.toastShortMessage(getResources().getString(
                            R.string.tc_login_activity_no_network_connection));
                }
            } else {
                showPasswordError(
                        getResources().getString(R.string.tc_login_activity_password_length_tip));
            }
        } else {
            showLoginError(getResources().getString(
                    R.string.tc_login_activity_username_does_not_meet_specifications));
        }
    }
    ...
    public static void updateStatement(final Context context, TextView tVUserProtocol) {
        ...
        ClickableSpan privacyClickableSpan = new NoRefCopyClickableSpan() {
            ...
            @Override
            public void onClick(View widget) {
                jumpToWebViewActivity(context, context.getString(R.string.login_privacy_protocol),
                        "https://privacy.qq.com/document/preview/cd1aaba55e1548c7975ef10fbe9785f7");
            }
        };
        builder.setSpan(privacyClickableSpan, privacyStartIndex, privacyEndIndex,
                Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        ...
        ClickableSpan userAgreementClickableSpan = new NoRefCopyClickableSpan() {
            ...
            @Override
            public void onClick(View widget) {
                jumpToWebViewActivity(context, context.getString(R.string.login_user_agreement),
                        "https://web.sdk.qcloud.com/document/Tencent-UGSV-User-Agreement.html");
            }
        };
