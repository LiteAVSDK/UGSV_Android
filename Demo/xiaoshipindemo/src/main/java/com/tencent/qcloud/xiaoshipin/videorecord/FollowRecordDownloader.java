...
public class FollowRecordDownloader {
    ...
    public void downloadVideo(TCVideoInfo tcVideoInfo) {
        if (tcVideoInfo.review_status == TCVideoInfo.REVIEW_STATUS_NOT_REVIEW) {
            ToastUtil.toastShortMessage(mContext.getResources().getString(
        ...
        File downloadFile =
                new File(downloadFileFolder, DownloadUtil.getNameFromUrl(tcVideoInfo.playurl));
        ...
        mProgressDialogUtil.setProgressDialogMessage(mContext.getResources().getString(
