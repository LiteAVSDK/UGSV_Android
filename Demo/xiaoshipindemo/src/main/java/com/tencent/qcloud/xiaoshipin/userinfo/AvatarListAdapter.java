...
public class AvatarListAdapter extends RecyclerView.Adapter<AvatarListAdapter.ViewHolder> {
    ...
    public AvatarListAdapter(
            Context context, List<String> list, OnItemClickListener onItemClickListener) {
    ...
    public interface OnItemClickListener { void onItemClick(String avatarUrl); }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final Context context, final String userAvatar, final int position,
            ...
            ImageLoader.loadImage(context, mImgHead, userAvatar, R.drawable.login_ic_head);
