...
public class TripleRecordVideoPicker
        extends AbsPickerUI implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    public void initDefault() {
        ...
        getTitleBar().setTitle(
                getResources().getString(com.tencent.qcloud.ugckit.R.string.ugckit_video_choose),
