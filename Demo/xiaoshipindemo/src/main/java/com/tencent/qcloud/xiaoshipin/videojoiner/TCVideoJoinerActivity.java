...
public class TCVideoJoinerActivity extends FragmentActivity {
    ...
    private IVideoJoinKit.OnVideoJoinListener mOnPictureListener =
            new IVideoJoinKit.OnVideoJoinListener() {
                @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initWindowParam();
        mTCVideoFileInfoList = (ArrayList<TCVideoFileInfo>) getIntent().getSerializableExtra(
