...
public class ShortVideoDialog extends DialogFragment implements View.OnClickListener {
    ...
    private void prepareToDownload(final boolean isTriple) {
        ...
        File downloadFile = new File(
                downloadFileFolder, DownloadUtil.getNameFromUrl(UGCKitConstants.CHORUS_URL));
        ...
        DownloadUtil.getInstance().download(UGCKitConstants.CHORUS_URL,
                UGCKitConstants.OUTPUT_DIR_NAME, new DownloadUtil.DownloadListener() {
                    String isDownloadIngTip = getResources().getString(
                            R.string.tc_vod_player_activity_download_video_is_downloading);
                    String downloadFailedTip = getResources().getString(
                            R.string.tc_vod_player_activity_download_video_download_failed);
                    @Override
    ...
    private void startTripleActivity(String path) {
        Intent intent = new Intent(
                getActivity(), TCVideoTripleScreenActivity.class); // TCVideoPreviewActivity
        intent.putExtra(UGCKitConstants.VIDEO_PATH, path);
        startActivity(intent);
    }
