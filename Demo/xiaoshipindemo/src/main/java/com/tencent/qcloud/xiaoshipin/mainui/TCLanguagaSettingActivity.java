...
public class TCLanguagaSettingActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        mRdoBtnTraditionalChinese.setTag(
                TCConfigManager.SystemConfig.Languages.TRADITIONAL_CHINESE);
        ...
        mRdoBtnTraditionalChinese.setOnCheckedChangeListener(
                mLangsRadioBtnsOnCheckedChangeListener);
    ...
    private CompoundButton.OnCheckedChangeListener mLangsRadioBtnsOnCheckedChangeListener =
