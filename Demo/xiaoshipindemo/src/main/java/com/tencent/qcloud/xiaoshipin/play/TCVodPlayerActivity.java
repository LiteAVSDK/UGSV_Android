...
public class TCVodPlayerActivity extends Activity
        implements ITXVodPlayListener, AudioFocusManager.OnAudioFocusChangeListener {
    ...
    private void initDatas() {
        ...
        mTCLiveInfoList =
                (List<TCVideoInfo>) intent.getSerializableExtra(UGCKitConstants.TCLIVE_INFO_LIST);
    ...
    private void initViews() {
        ...
        mImgBtnFollowShot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FollowRecordDownloader downloader =
                        new FollowRecordDownloader(TCVodPlayerActivity.this);
        ...
        mVerticalViewPager.setPageTransformer(false, new ViewPager.PageTransformer() {
            ...
            public void transformPage(View page, float position) {
                TXCLog.d(TAG,
                        "transformPage position = " + position + " mCurrentPosition"
                                + mCurrentPosition);
                if (position != 0) {
                    return;
                }
    ...
    class MyPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            View view = LayoutInflater.from(container.getContext())
                                .inflate(R.layout.view_player_content, null);
            view.setId(position);
            ...
            if (videoInfo.review_status == TCVideoInfo.REVIEW_STATUS_PORN) { //涉黄的图片不显示
                ...
                BitmapUtils.blurBgPic(TCVodPlayerActivity.this, coverImageView,
                        videoInfo.frontcover, R.drawable.bg);
            }
            // 头像
            CircleImageView ivAvatar = (CircleImageView) view.findViewById(R.id.player_civ_avatar);
            Glide.with(TCVodPlayerActivity.this)
                    .load(videoInfo.headpic)
