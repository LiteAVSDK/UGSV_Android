 ...
 * 合唱
 */
public class TCVideoFollowRecordActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MixRecordConfigBuildInfo buildInfo = new MixRecordConfigBuildInfo(
                paths, 0, 720 * 2, 1280, TXRecordCommon.VIDEO_ASPECT_RATIO_9_16);
        ...
        mUGCKitVideoFollowRecord.setOnMixRecordListener(
                new IVideoMixRecordKit.OnMixRecordListener() {
                    @Override
                    ...
                    @Override
                    public void onMixRecordAction(
                            IVideoMixRecordKit.MixRecordActionT actionT, Object object) {
                        if (actionT
                                == IVideoMixRecordKit.MixRecordActionT.MIX_RECORD_ACTION_T_SELECT) {
                            MixRecordActionData data = (MixRecordActionData) object;
                            Intent intent = new Intent(TCVideoFollowRecordActivity.this,
                                    TCTripleRecordVideoPickerActivity.class);
                            startActivityForResult(intent, REQUEST_CODE);
                        }
                    }
                });
        mAudioPermissionManager =
                new PermissionManager(this, PermissionManager.PermissionType.AUDIO);
        mCameraPermissionManager =
                new PermissionManager(this, PermissionManager.PermissionType.CAMERA);
        mStoragePermissionManager =
                new PermissionManager(this, PermissionManager.PermissionType.STORAGE);
