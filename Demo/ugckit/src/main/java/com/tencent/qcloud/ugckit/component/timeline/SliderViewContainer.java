...
public class SliderViewContainer extends LinearLayout {
    ...
    public interface OnStartTimeChangedListener { void onStartTimeMsChanged(long timeMs); }
    ...
    public void setOnStartTimeChangedListener(
            OnStartTimeChangedListener onStartTimeChangedListener) {
    ...
    private void init(Context context) {
        mContext = context;
        mRootView =
                LayoutInflater.from(context).inflate(R.layout.ugckit_layout_repeat_slider, this);
    ...
    private void setTouchProcessListener() {
        mViewTouchProcess.setOnPositionChangedListener(
                new ViewTouchProcess.OnPositionChangedListener() {
                    ...
                    public void onPostionChanged(float distance) {
                        ...
                        long duration =
                                VideoEditerSDK.getInstance().getVideoDuration() - mStartTimeMs;
                        ...
                        mStartTimeMs = Math.min(mStartTimeMs,
    ...
    public void changeLayoutParams() {
        if (mVideoProgressController != null) {
            ...
            layoutParams.leftMargin =
                    mVideoProgressController.calculateSliderViewPosition(SliderViewContainer.this);
