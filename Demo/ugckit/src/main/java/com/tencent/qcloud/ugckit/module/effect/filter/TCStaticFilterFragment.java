 ...
 * 静态滤镜的Fragment
 */
public class TCStaticFilterFragment
        extends Fragment implements BaseRecyclerAdapter.OnItemClickListener {
    private static final int[] FILTER_ARR = {R.drawable.ugckit_filter_biaozhun,
            R.drawable.ugckit_filter_yinghong, R.drawable.ugckit_filter_yunshang,
            R.drawable.ugckit_filter_chunzhen, R.drawable.ugckit_filter_bailan,
            R.drawable.ugckit_filter_yuanqi, R.drawable.ugckit_filter_chaotuo,
            R.drawable.ugckit_filter_xiangfen,
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        originIcon = UIAttributeUtil.getResResources(
                getContext(), R.attr.editerFilterOriginIcon, R.drawable.ugckit_orginal);
        normalIcon = UIAttributeUtil.getResResources(
                getContext(), R.attr.editerFilterNormalIcon, R.drawable.ugckit_biaozhun);
        yinghongIcon = UIAttributeUtil.getResResources(
                getContext(), R.attr.editerFilterYinghongIcon, R.drawable.ugckit_yinghong);
        yunchangIcon = UIAttributeUtil.getResResources(
                getContext(), R.attr.editerFilterYunchangIcon, R.drawable.ugckit_yunshang);
        chunzhenIcon = UIAttributeUtil.getResResources(
                getContext(), R.attr.editerFilterChunzhenIcon, R.drawable.ugckit_chunzhen);
        bailanIcon = UIAttributeUtil.getResResources(
                getContext(), R.attr.editerFilterBailanIcon, R.drawable.ugckit_bailan);
        yuanqiIcon = UIAttributeUtil.getResResources(
                getContext(), R.attr.editerFilterYuanqiIcon, R.drawable.ugckit_yuanqi);
        chaotuoIcon = UIAttributeUtil.getResResources(
                getContext(), R.attr.editerFilterChaotuoIcon, R.drawable.ugckit_chaotuo);
        xiangfengIcon = UIAttributeUtil.getResResources(
                getContext(), R.attr.editerFilterXiangfenIcon, R.drawable.ugckit_xiangfen);
        langmanIcon = UIAttributeUtil.getResResources(
                getContext(), R.attr.editerFilterLangmanIcon, R.drawable.ugckit_langman);
        qingxinIcon = UIAttributeUtil.getResResources(
                getContext(), R.attr.editerFilterQingxinIcon, R.drawable.ugckit_qingxin);
        weimeiIcon = UIAttributeUtil.getResResources(
                getContext(), R.attr.editerFilterWeimeiIcon, R.drawable.ugckit_weimei);
        fennenIcon = UIAttributeUtil.getResResources(
                getContext(), R.attr.editerFilterFennenIcon, R.drawable.ugckit_fennen);
        huaijiuIcon = UIAttributeUtil.getResResources(
                getContext(), R.attr.editerFilterHuaijiuIcon, R.drawable.ugckit_huaijiu);
        landiaoIcon = UIAttributeUtil.getResResources(
                getContext(), R.attr.editerFilterLandiaoIcon, R.drawable.ugckit_landiao);
        qingliangIcon = UIAttributeUtil.getResResources(
                getContext(), R.attr.editerFilterQingliangIcon, R.drawable.ugckit_qingliang);
        rixiIcon = UIAttributeUtil.getResResources(
                getContext(), R.attr.editerFilterRixiIcon, R.drawable.ugckit_rixi);
        ...
        mFilerNameList.add(
                getResources().getString(R.string.ugckit_static_filter_fragment_original));
        mFilerNameList.add(
                getResources().getString(R.string.ugckit_static_filter_fragment_standard));
        ...
        mFilerNameList.add(
                getResources().getString(R.string.ugckit_static_filter_fragment_vitality));
        mFilerNameList.add(getResources().getString(R.string.ugckit_static_filter_fragment_super));
        mFilerNameList.add(
                getResources().getString(R.string.ugckit_static_filter_fragment_fragrance));
        mFilerNameList.add(
                getResources().getString(R.string.ugckit_static_filter_fragment_romantic));
        mFilerNameList.add(getResources().getString(R.string.ugckit_static_filter_fragment_fresh));
        mFilerNameList.add(
                getResources().getString(R.string.ugckit_static_filter_fragment_beautiful));
        mFilerNameList.add(getResources().getString(R.string.ugckit_static_filter_fragment_pink));
        mFilerNameList.add(
                getResources().getString(R.string.ugckit_static_filter_fragment_reminiscence));
        ...
        mFilerNameList.add(
                getResources().getString(R.string.ugckit_static_filter_fragment_Japanese));
