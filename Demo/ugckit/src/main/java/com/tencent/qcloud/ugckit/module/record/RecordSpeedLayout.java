 ...
 */
public class RecordSpeedLayout
        extends RelativeLayout implements RadioGroup.OnCheckedChangeListener, IRecordSpeedLayout {
    ...
    private void initViews() {
        ...
        mSlowestBg = UIAttributeUtil.getResResources(
                mActivity, R.attr.recordSpeedSlowestBackgroud, R.drawable.ugckit_record_left_bg);
        mSlowBg = UIAttributeUtil.getResResources(
                mActivity, R.attr.recordSpeedSlowBackground, R.drawable.ugckit_record_mid_bg);
        mNormalBg = UIAttributeUtil.getResResources(
                mActivity, R.attr.recordSpeedNormalBackground, R.drawable.ugckit_record_mid_bg);
        mFastBg = UIAttributeUtil.getResResources(
                mActivity, R.attr.recordSpeedFastBackground, R.drawable.ugckit_record_mid_bg);
        mFastestBg = UIAttributeUtil.getResResources(
                mActivity, R.attr.recordSpeedFastestBackground, R.drawable.ugckit_record_right_bg);
