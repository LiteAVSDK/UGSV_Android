...
public class RangeSliderViewContainer extends LinearLayout {
    ...
    public RangeSliderViewContainer(
    ...
    public void init(@NonNull VideoProgressController videoProgressController, long startTimeMs,
            long durationMs, long maxDurationMs) {
        ...
        setMiddleRangeColor(
                mContext.getResources().getColor(R.color.ugckit_color_accent_transparent30));
    ...
    private void setTouchProcessListener() {
        mStartViewTouchProcess.setOnPositionChangedListener(
                new ViewTouchProcess.OnPositionChangedListener() {
                    @Override
                    public void onPostionChanged(float distance) {
                        ...
                        Log.i(TAG,
                                String.format(Locale.getDefault(),
                                        "onPostionChanged, mStartView distance = %f, dtime = %d",
                                        distance, dtime));
                        ...
                        MarginLayoutParams layoutParams =
                                (MarginLayoutParams) mStartView.getLayoutParams();
                        int dx = layoutParams.leftMargin;

                        Log.i(TAG,
                                String.format(Locale.getDefault(),
                                        "onPostionChanged, mStartView layoutParams.leftMargin = %d",
        ...
        mEndViewTouchProcess.setOnPositionChangedListener(
                new ViewTouchProcess.OnPositionChangedListener() {
                    @Override
                    public void onPostionChanged(float distance) {
                        long dtime = mVideoProgressController.distance2Duration(distance);
                        ...
                        ViewGroup.LayoutParams layoutParams = mMiddleView.getLayoutParams();
                        layoutParams.width =
                                mVideoProgressController.duration2Distance(mDurationMs);
