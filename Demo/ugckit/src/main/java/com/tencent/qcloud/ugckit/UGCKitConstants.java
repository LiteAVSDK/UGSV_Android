...
public class UGCKitConstants {
    public static final String APP_SVR_URL =
            "http://demo.vod2.myqcloud.com/lite"; // 业务Server的地址
                                                  // 如果您的服务器没有部署https证书，这里需要用http
    public static final String SVR_BGM_GET_URL =
            "https://liteav.sdk.qcloud.com/app/res/bgm/bgm_list.json"; // BGM列表地址
    ...
    public static final int ACTIVITY_MUSIC_REQUEST_CODE =
            1; // bgm activity request code and intent extra
    ...
    // 合唱演示视频地址
    public static final String CHORUS_URL =
            "http://1400100725.vod2.myqcloud.com/8b7d5993vodgzp1400100725/d864a3545285890780576877210/ss2W2I8oIn4A.mp4";
    /**
