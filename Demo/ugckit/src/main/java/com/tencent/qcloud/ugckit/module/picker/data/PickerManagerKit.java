...
public class PickerManagerKit {
    ...
    public static PickerManagerKit getInstance(@NonNull Context context) {
        if (sInstance == null) sInstance = new PickerManagerKit(context);
        return sInstance;
    }
    ...
    public ArrayList<TCVideoFileInfo> getAllVideo() {
        ...
        String[] mediaColumns = new String[] {MediaStore.Video.VideoColumns._ID,
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                fileItem.setFilePath(cursor.getString(
                        cursor.getColumnIndexOrThrow(MediaStore.Video.Media.DATA)));
                fileItem.setFileName(cursor.getString(
    ...
    public ArrayList<TCVideoFileInfo> getAllPictrue() {
        ...
        String[] mediaColumns = new String[] {MediaStore.Images.Media._ID,
                ...
                // DATA 数据在 Android Q 以前代表了文件的路径，但在 Android Q上该路径无法被访问。
                MediaStore.Images.Media.DATA, MediaStore.Images.Media.DESCRIPTION};
