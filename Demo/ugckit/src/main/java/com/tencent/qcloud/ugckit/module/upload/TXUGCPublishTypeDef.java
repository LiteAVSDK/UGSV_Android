...
public class TXUGCPublishTypeDef {
    ...
    public final static class TXPublishParam {
        ...
        public boolean enablePreparePublish =
    ...
    public static final int PUBLISH_RESULT_UPLOAD_REQUEST_FAILED =
            1001; // step1: “短视频/媒体”发送失败
    public static final int PUBLISH_RESULT_UPLOAD_RESPONSE_ERROR =
            1002; // step1: “短视频/媒体上传请求”收到错误响应
    ...
    public static final int PUBLISH_RESULT_PUBLISH_REQUEST_FAILED =
            1005; // step3: “短视频/媒体发布请求”发送失败
    public static final int PUBLISH_RESULT_PUBLISH_RESPONSE_ERROR =
            1006; // step3: “短视频/媒体发布请求”收到错误响应
