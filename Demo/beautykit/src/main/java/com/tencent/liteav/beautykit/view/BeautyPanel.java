package com.tencent.liteav.beautykit.view;
...
import com.tencent.liteav.beautykit.Beauty;
import com.tencent.liteav.beautykit.BeautyImpl;
import com.tencent.liteav.beautykit.R;
import com.tencent.liteav.beautykit.adapter.ItemAdapter;
import com.tencent.liteav.beautykit.adapter.TabAdapter;
...
public class BeautyPanel extends FrameLayout implements SeekBar.OnSeekBarChangeListener, View.OnClickListener {
    ...
    private void initialize(Context context) {
        mContext = context;
        LayoutInflater.from(context).inflate(R.layout.beautykit_view_layout, this);
    ...
    private void setBeautyTitle(String title) {
        mTextTitle.setText(ResourceUtils.getString(title) + ResourceUtils.getString(R.string.beautykit_setup));
    }
}
