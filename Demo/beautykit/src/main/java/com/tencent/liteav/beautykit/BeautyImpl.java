package com.tencent.liteav.beautykit;
...
import com.tencent.liteav.beautykit.download.DownloadListener;
import com.tencent.liteav.beautykit.download.MaterialDownloader;
...
import com.tencent.liteav.beautykit.utils.ResourceUtils;
import com.tencent.liteav.beautykit.utils.SPUtils;
import com.tencent.liteav.beautykit.view.ProgressDialog;
...
public class BeautyImpl implements Beauty {
    ...
    public void restoreBeauty() {
        if (mBeautyManager != null && mBeautyParams != null) {
    ...
    private void setMaterialEffects(@NonNull final TabInfo tabInfo, @NonNull final ItemInfo itemInfo) {
        ...
        if (!TextUtils.isEmpty(itemMaterialPath)) {
            if (tabInfo.getTabType() == BeautyConstants.TAB_TYPE_GESTURE
                ...
                showToast(ResourceUtils.getString(R.string.beautykit_palm_out));
            }
