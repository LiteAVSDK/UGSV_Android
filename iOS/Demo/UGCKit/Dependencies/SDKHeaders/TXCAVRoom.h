...
#define TXCAVRoom_DEPRECAETD_BEAUTY_API __deprecated_msg("Use getBeautyManager instead.")
 ...
 */
- (void)setBeautyLevel:(int)beautyLevel whitenessLevel:(int)whitenessLevel ruddinessLevel:(int)ruddinessLevel TXCAVRoom_DEPRECAETD_BEAUTY_API;
 ...
 */
- (void)setEyeScaleLevel:(float)eyeScaleLevel TXCAVRoom_DEPRECAETD_BEAUTY_API;
 ...
 */
- (void)setFaceScaleLevel:(float)faceScaleLevel TXCAVRoom_DEPRECAETD_BEAUTY_API;
 ...
 */
- (void)setFilter:(UIImage *)filterImage TXCAVRoom_DEPRECAETD_BEAUTY_API;
 ...
 *          tmplDir: 动效所在目录
 */
- (void)selectMotionTmpl:(NSString *)tmplName inDir:(NSString *)tmplDir TXCAVRoom_DEPRECAETD_BEAUTY_API;
 ...
 */
- (void)setFaceVLevel:(float)vLeve TXCAVRoom_DEPRECAETD_BEAUTY_API;
 ...
 */
- (void)setFaceShortLevel:(float)shortLevel TXCAVRoom_DEPRECAETD_BEAUTY_API;
 ...
 */
- (void)setNoseSlimLevel:(float)slimLevel TXCAVRoom_DEPRECAETD_BEAUTY_API;
 ...
 */
- (void)setChinLevel:(float)chinLevel TXCAVRoom_DEPRECAETD_BEAUTY_API;
 ...
 *          style  0:光滑美颜，1:自然美颜
 */
- (void)setBeautyStyle:(int)style TXCAVRoom_DEPRECAETD_BEAUTY_API;
