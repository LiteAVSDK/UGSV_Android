//
//  QCloudListMultipartUploadContent.h
//  QCloudListMultipartUploadContent
//
//  Created by tencent
...
用来标识分块的存储级别
*/
@property (assign, nonatomic) QCloudCOSStorageClass storeageClass;
/**
表示本次上传发起者的信息
*/
@property (strong, nonatomic) NSString *initiated;
/**
表示这些分块所有者的信息
*/
