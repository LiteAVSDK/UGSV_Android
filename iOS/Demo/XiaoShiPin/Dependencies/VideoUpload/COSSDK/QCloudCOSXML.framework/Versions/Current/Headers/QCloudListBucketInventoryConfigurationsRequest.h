//
//  ListBucketInventoryConfigurations.h
...
- (void)setFinishBlock:(void (^_Nullable)(QCloudListInventoryConfigurationResult *_Nullable result,
                                          NSError *_Nullable error))QCloudRequestFinishBlock;
@end
