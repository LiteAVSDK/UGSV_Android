...
#define QCloudLogError(frmt, ...) QCloudLog(QCloudLogLevelError, (frmt), ##__VA_ARGS__)

#define QCloudLogWarning(frmt, ...) QCloudLog(QCloudLogLevelWarning, (frmt), ##__VA_ARGS__)

#define QCloudLogInfo(frmt, ...) QCloudLog(QCloudLogLevelInfo, (frmt), ##__VA_ARGS__)
...
#define QCloudLogTrance() QCloudLog(QCloudLogLevelDebug, @"%@", [NSThread callStackSymbols])
