...
@implementation UGCKitRecordView
...
- (void)_configRecordButton {
    ...
    if (_recordButtonStyle == UGCKitRecordButtonStylePause) {
        [_btnStartRecord setImage:_theme.pauseInnerIcon forState:UIControlStateNormal];
        [_btnStartRecord setBackgroundImage:_theme.pauseBackgroundImage forState:UIControlStateNormal];
